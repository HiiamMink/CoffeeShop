    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBan = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BanSo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tables", x => x.MaBan);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MaKH = table.Column<int>(type: "int", nullable: false),
                    SoDiemTichLuy = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiemTichLuys", x => x.MaKH);
                    table.ForeignKey(
                        name: "FK_DiemTichLuy_KhachHang_MaKH",
                        column: x => x.MaKH,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoaiChamCong = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
